...
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]$(if [[ $(git rev-parse --is-inside-work-tree 2>/dev/null) == "true" ]]; then echo "\[\033[31m\][$(parse_git_branch) $(git_status)]\[\033[00m\]"; fi)\$ '
else
